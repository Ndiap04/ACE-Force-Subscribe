      ...
      try:
        ...
        try:
          sent_message = await message.reply_text(
              " {} **kamu belum bergabung dengan saluran kami** @BottyCu silakan bergabung menggunakan tombol di bawah ini dan tekan tombol suarakan saya untuk membunyikan suara anda sendiri.".format(message.from_user.mention, channel, channel),
